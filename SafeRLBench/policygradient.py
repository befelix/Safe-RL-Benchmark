...
class LinearFDEstimator(object):
    ...
    def optimize(self, policy):
        ...
        for n in range(self.max_it):
            ...
            grad, trace, achieved = self._estimate_gradient(policy, 
                                                            parameter,
                                                            2*self.par_dim)
    ...
    def _estimate_gradient(self, policy, parameter, iterations):
        grad, trace, achieved = self._estimate_forward_gradient(policy, parameter, iterations)
        return(grad, trace, achieved)

    def _estimate_forward_gradient(self, policy, parameter, iterations):
    ...
    def _estimate_central_gradient(self, policy, parameter, iterations):
        executer = self.executer
    ...
    def _initialize_parameters(self, policy):
        ...
        while True:
            ...
            grad, _, _ = self._estimate_gradient(policy, parameter, 2*self.par_dim)
